...
export default function PrivacyPoliciesPage() {
  ...
  return <div className="min-h-full bg-transparent"><main className="mx-auto max-w-7xl space-y-6 p-4 pt-20 sm:p-6 sm:pt-20 lg:p-8 lg:pt-8">
    ...
    {!policies.length && <EmptyState icon={FilePlus2} title="No privacy policies yet" message="Create the first policy before accepting registrations." action={<Button leftIcon={<Plus size={16} />} onClick={openNew}>Add privacy policy</Button>} />}
  </main>
