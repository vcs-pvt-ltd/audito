...
export default function SetupStructurePage() {
 ...
 <div className="mb-6 flex gap-3 rounded-2xl border border-secondary-500/25 bg-gradient-to-r from-secondary-500/[0.13] via-secondary-500/[0.06] to-transparent p-1 sm:items-center sm:p-2">
        ...
        {loading ? (
          ...
          <EmptyState icon={Search} title="No matching results" message="Try adjusting your search query." />
        ) : (
                  ...
                  <div key={`${entity.code}-${index}`} className="glass rounded-xl border border-white/10 p-4">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div className="col-span-2 rounded-lg bg-white/[0.03] border border-white/10 px-2.5 py-2">
                        ...
                        <p className="text-gray-300 mt-0.5 truncate">{entity.created_at ? new Date(String(entity.created_at)).toLocaleDateString() : "-"}</p>
                      </div>
                    </div>
