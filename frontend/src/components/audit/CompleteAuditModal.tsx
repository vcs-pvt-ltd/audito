...
export default function CompleteAuditModal({
    ...
    return (
      <div>
        <button
          ...
          className="w-full flex items-center gap-2 text-left px-3 py-2.5 rounded-lg hover:bg-white/[0.03] transition-colors"
        ...
        {isExpanded && isAuditEntity && qs.length > 0 && (
          <div className="mt-2 mb-3 rounded-xl border border-white/10 bg-white/[0.02] overflow-hidden" style={{ marginLeft: 12 + depth * 14 }}>
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative glass rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <h3 className="text-base font-semibold text-white mt-1">{audit.title}</h3>
                </div>
        ...
        <div className="p-4 border-t border-white/10 flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg text-xs font-semibold bg-secondary-500 text-primary-950 hover:bg-secondary-400 transition-all disabled:opacity-50"
          >
